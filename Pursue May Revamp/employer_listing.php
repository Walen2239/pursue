...
$jobListings = getJobListingsByEmployerId($conn, $employer_id);
        ...
        <div class="row">
            <aside class="col-md-3 col-lg-2 sidebar p-4 bg-dark">
                ...
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link text-white" href="employer_dashboard.php">All Category</a>
                    <a class="nav-link text-white" href="#">About Us</a>
                    <a href="employer_add_job.php" style="margin-top:2rem" class="nav-link text-white">New Listing</a>
                    <a href="employer_listing.php" class="nav-link active fw-bold text-white">Your Listing</a>
            ...
            <main class="col-md-9 col-lg-10 p-4 main-content mt-2">
                <div class="row justify-content-center g-4 mt-2">
                    <h2 class="mb-4 text-center">Your Job Listings</h2>
